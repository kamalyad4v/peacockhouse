    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 z-[0] opacity-40">
        <div
          ...
          style={{
            background: "radial-gradient(circle, rgba(9,121,105,0.12) 0%, transparent 60%)",
            animation: "pk-slow-drift 12s ease-in-out infinite",
          }}
        />
        <div
          className="absolute right-[10%] bottom-[10%] h-[500px] w-[500px] rounded-full"
          style={{
          ...
          <div className="md:col-span-5">
            ...
            >
              ...
              >
                A house
                <br />
                <span className="italic text-[color:var(--pk-gold-light)]">woven from</span>
                <br />
                jewel &amp; thread.
              </h2>
          ...
          <div className="md:col-span-7 md:col-start-7">
            <div className="flex flex-col gap-14">
              ...
              >
                ...
                >
                  Born in the courtyard workshops of old Chennai, Peacock Blouse House began
                  with a single silk thread, a needle of tempered gold, and an obsession with
                  the iridescent hush of a peacock&apos;s wing.
                </p>
              </div>
              ...
              >
                ...
                >
                  Every blouse is a private ceremony — cut, threaded, and finished by hand
                  across seven pairs of hands. We do not chase seasons. We chase the light
                  that lingers on the collarbone of a woman who knows exactly who she is.
                </p>
              </div>
              ...
              <div className="mt-2 grid grid-cols-2 gap-8 border-t border-[color:var(--pk-gold)]/15 pt-10">
                ...
                <Metric label="Master artisans" value="42" testid="pk-metric-artisans" />
              </div>
            </div>
          </div>
        </div>
