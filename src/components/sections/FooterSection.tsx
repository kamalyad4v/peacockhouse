      ...
      <div className="relative mx-auto max-w-[100rem] px-6 py-24 md:px-12 md:py-32 lg:px-24">
        ...
        >
          <div className="col-span-12 md:col-span-7">
            ...
            >
              Receive the House
              <br />
              <span className="italic text-[color:var(--pk-gold-light)]">dispatch.</span>
            </h3>
          </div>
        ...
        <div className="mt-16 grid grid-cols-1 gap-14 md:grid-cols-12">
          <div className="md:col-span-4">
            ...
            <p className="mt-6 max-w-xs font-sans text-sm font-light leading-relaxed text-white/50">
              Hand-embroidered couture blouses, crafted one thread at a time in the ateliers
              of southern India.
            </p>
          </div>
        ...
        <div className="mt-20 flex flex-col items-start justify-between gap-4 border-t border-[color:var(--pk-gold)]/10 pt-8 md:flex-row md:items-center">
          ...
          <div className="flex gap-6 font-sans text-[11px] tracking-[0.2em] text-white/40">
            <a href="#" className="hover:text-white/70" data-testid="pk-legal-privacy">PRIVACY</a>
            <a href="#" className="hover:text-white/70" data-testid="pk-legal-terms">TERMS</a>
            <a href="#" className="hover:text-white/70" data-testid="pk-legal-imprint">IMPRINT</a>
          </div>
        </div>
      </div>
...
function FeatherEyeMark() {
  return (
    <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" data-testid="pk-footer-mark">
...
function FeatherOrnament() {
  return (
    <svg className="pointer-events-none absolute left-1/2 top-0 -translate-x-1/2 -translate-y-1/2" width="120" height="24" viewBox="0 0 120 24" fill="none" aria-hidden="true">
